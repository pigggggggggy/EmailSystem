...
from email_system.skills.json_utils import ModelOutputParseError, fallback_summary_from_text, parse_json_object
...
class SummarizeEmailSkill:
    ...
    def run(self, email: Email, context: dict, llm: LLMClient) -> dict:
        ...
        try:
            ...
            data = {
                "summary": fallback_summary_from_text(email.body_text),
                "confidence": 0.0,
                "parse_error": str(exc),
